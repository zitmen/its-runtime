...
int main()
{
	...
	try
	{
		...
		interpreter.setOption(Interpreter::Options::HeapSize, 1*1024*1024);	// 32MB
		interpreter.setOption(Interpreter::Options::StackSize, 1*1024*1024);	// 32MB
		interpreter.setOption(Interpreter::Options::GarbageCollector, 0.0);	// start GC if 90% of heap is full (set 0% for no GC)
